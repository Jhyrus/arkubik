...
?>
	...
	<footer id="colophon_TesseractTheme" class="site-footer <?php echo $footpos; ?>" role="contentinfo">
		...
		<?php } ?>
            ...
            <div id="footer-banner-right" class="designer">
            	<div class="table">
            		<div class="table-cell">
            			<span class="sandia">© Sandia Creativa S.R.L. 2016</span>
            			<div class="redes">
            			<a href="https://www.instagram.com/arkubik_srl/" target="_blank"><img src="http://107.170.50.28/arkubik/wp-content/uploads/2017/01/logos-web-Arkubik-01.png" width="30px" alt=""></a>
            			<a href="https://www.facebook.com/arkubik/?fref=ts" target="_blank"><img src="http://107.170.50.28/arkubik/wp-content/uploads/2017/01/logos-web-Arkubik-02.png" width="30px" alt=""></a>
            			</div>
            		</div>
            	</div>
            </div>
